...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../src/framework/core/ebent-bus.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  EventBus.prototype.emit = function (event) {
    ...
    for (var _a = 0, _b = this.listeners[event]; _a < _b.length; _a++) {
      var listener = _b[_a];
      listener.apply(void 0, arguments_);
    }
  };
...
},{}],"../src/utils/modules/isEmpty.ts":[function(require,module,exports) {
"use strict";
...
},{}],"../src/framework/core/block.ts":[function(require,module,exports) {
"use strict";
...
var ebent_bus_ts_1 = require("./ebent-bus.ts");

var isEmpty_1 = __importDefault(require("../../utils/modules/isEmpty"));

var templator = require('vue-template-compiler');
...
function () {
  function Block(properties) {
    ...
    this.eventBus = new ebent_bus_ts_1.EventBus();
  ...
  Block.prototype._created = function () {
    if (this.template) {
      var compiled = templator.compile(this.template, this.data);
  ...
  Block.prototype._mounted = function () {
    if (this.selector) {
      var target = this._getTarget(this.selector);

      this.parent = this._getParent(target);
      target.replaceWith(this.getNode());
      if (this.components) for (var _i = 0, _a = this.components; _i < _a.length; _i++) {
        var c = _a[_i];
        c.init();
      }
    }
  ...
  Block.prototype.created = function () {};

  Block.prototype.mounted = function () {};

  Block.prototype._makePropsProxy = function (data) {
  ...
  Block.prototype._getTarget = function (selector) {
    return document.querySelector(selector);
  };

  Block.prototype._getParent = function (target) {
    return target.parentNode;
  };

  Block.prototype._createResources = function (compiled) {
    this.el = this._createDocumentElement(compiled.ast);
  };

  Block.prototype._createDocumentElement = function (object) {
    var _this = this;

    if (!object.children) return;
    var children = object.children;
    var nodeElement = document.createElement(object.tag);

    if (!isEmpty_1.default(object.attrsMap)) {
      var attrs_1 = object.attrsMap;

      var _loop_1 = function _loop_1(key) {
        if (key === '@click') {
          nodeElement.addEventListener('click', this_1.methods[attrs_1[key]].bind(this_1));
        } else if (key === 'v-model') {
          if (nodeElement.tagName === 'INPUT') {
            nodeElement.addEventListener('input', function () {
              _this.setProps(attrs_1[key], nodeElement.value);
            });
          }
        } else {
          this_1._setAttrs(nodeElement, key, attrs_1[key]);
        }
      };

      var this_1 = this;

      for (var key in attrs_1) {
        _loop_1(key);
      }
    }
    ...
    for (var key in children) {
      var child = this._createDocumentElement(children[key]);
  ...
  Block.prototype._setAttrs = function (element, key, value) {
...
exports.Block = Block;
},{"./ebent-bus.ts":"../src/framework/core/ebent-bus.ts","../../utils/modules/isEmpty":"../src/utils/modules/isEmpty.ts","vue-template-compiler":"../node_modules/vue-template-compiler/browser.js"}],"../src/app/app.template.js":[function(require,module,exports) {
"use strict";
...
var _navigationTemplate = require("./navigation.template.js");
...
var Navigation = /*#__PURE__*/function (_Block) {
  _inherits(Navigation, _Block);
...
},{"./navigation.template.js":"../src/components/navigation/navigation.template.js","../../framework/core/block":"../src/framework/core/block.ts"}],"../src/app/app.component.ts":[function(require,module,exports) {
"use strict";
...
var block_ts_1 = require("../framework/core/block.ts");
...
exports.app = new App({
  selector: 'app',
  template: app_template_1.appTemplate,
  components: [navigation_component_1.navigation]
});
},{"../framework/core/block.ts":"../src/framework/core/block.ts","./app.template":"../src/app/app.template.js","../components/navigation/navigation.component":"../src/components/navigation/navigation.component.js"}],"../src/assets/style/style.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"
ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  Validation.prototype.getResult = function (type, value) {
    return Validation.REGULAR_EXPRESSIONS[type].test(value);
  };

  Validation.prototype.handleValidation = function (element, value) {
    var result = this.getResult(element.type, value);
    var target = element.target ? element.target : element.domElement;
  ...
  Validation.prototype.setValidation = function (flag) {
    var _this = this;

    this.elements.forEach(function (element) {
      element.events.forEach(function (event) {
        if (!flag) {
          element.domElement.removeEventListener(event, function (e) {
            return _this.handleValidation(element, e.target.value);
          });
        } else {
          element.domElement.addEventListener(event, function (e) {
            return _this.handleValidation(element, e.target.value);
          });
        }
      });
  ...
  Validation.prototype.on = function () {
    this.setValidation(true);
  };

  Validation.prototype.off = function () {
    this.setValidation(false);
  };

  Validation.REGULAR_EXPRESSIONS = {
    login: /^[a-zA-Zа-яА-Я?!@#$%^&*??0-9?]{2,20}$/,
    phone: /^\+?[78][-\(]?\d{3}\)?-?\d{3}-?\d{2}-?\d{2}$/,
    email: /^([a-z0-9_-]+\.)*[a-z0-9_-]+@[a-z0-9_-]+(\.[a-z0-9_-]+)*\.[a-z]{2,6}$/,
    name: /^[a-zA-Zа-яА-Я]{2,20}$/,
    password: /^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?!.*\s).*$/g
  };
  return Validation;
}();

exports.Validation = Validation;
},{}],"../src/pages/login/login.component.ts":[function(require,module,exports) {
"use strict";
...
var login_template_1 = require("./login.template");

var validation_ts_1 = require("../../framework/core/validation.ts");
...
function (_super) {
  ...
  function LoginPage(properties) {
    return _super.call(this, properties) || this;
  }

  LoginPage.prototype.mounted = function () {
    var mail = {
    ...
    var validation = new validation_ts_1.Validation([mail, password]);
    validation.on();
  };
...
exports.loginPage = new LoginPage({
  selector: 'login',
  template: login_template_1.loginTemplate,
  data: {
    email: '',
    password: ''
  },
...
},{"../../framework/core/block.ts":"../src/framework/core/block.ts","./login.template":"../src/pages/login/login.template.js","../../framework/core/validation.ts":"../src/framework/core/validation.ts"}],"../src/pages/registration/registration.template.js":[function(require,module,exports) {
"use strict";
...
},{}],"../src/pages/registration/registration.component.ts":[function(require,module,exports) {
"use strict";
...
var registration_template_1 = require("./registration.template");
...
function (_super) {
  ...
  function RegistrationPage(properties) {
    return _super.call(this, properties) || this;
  }

  RegistrationPage.prototype.mounted = function () {
    var mail = {
      domElement: document.querySelector('#email'),
      type: 'email',
      classError: 'no-valid',
    ...
    new validation_ts_1.Validation([mail, phone, login, name, surname, password, passwordRepeat]).on();
  };
...
exports.registrationPage = new RegistrationPage({
  ...
  template: registration_template_1.registrationPageTemplate,
  data: {
    email: '',
    login: '',
    name: '',
...
},{"../../framework/core/block.ts":"../src/framework/core/block.ts","./registration.template":"../src/pages/registration/registration.template.js","../../framework/core/validation.ts":"../src/framework/core/validation.ts"}],"../src/pages/home/home.template.js":[function(require,module,exports) {
"use strict";
...
},{}],"../src/assets/img/users__avatars/avatar-3.png":[function(require,module,exports) {
module.exports = "/avatar-3.21828aec.png";
},{}],"../src/pages/home/chatField/chat-field.template.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.chatFieldTemplate = void 0;
...
var chat_field_template_1 = require("./chat-field.template");

var ChatField =
/** @class */
function (_super) {
  __extends(ChatField, _super);

  function ChatField(properties) {
    return _super.call(this, properties) || this;
  }
...
exports.chatField = new ChatField({
  data: {
    chatList: [{
  ...
  selector: 'chatfield',
  template: chat_field_template_1.chatFieldTemplate
});
},{"../../../framework/core/block.ts":"../src/framework/core/block.ts","./chat-field.template":"../src/pages/home/chatField/chat-field.template.js"}],"../src/assets/img/users__avatars/avatar-2.png":[function(require,module,exports) {
module.exports = "/avatar-2.0be10e11.png";
},{}],"../src/pages/home/chatList/chat-list.template.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.chatListTemplate = void 0;
...
var _block = require("../../../framework/core/block.ts");

var _chatList = require("./chat-list.template");
...
var ChatList = /*#__PURE__*/function (_Block) {
  _inherits(ChatList, _Block);
...
var chatList = new ChatList({
  selector: 'chatlist',
  template: _chatList.chatListTemplate
});
exports.chatList = chatList;
},{"../../../framework/core/block.ts":"../src/framework/core/block.ts","./chat-list.template":"../src/pages/home/chatList/chat-list.template.js"}],"../src/pages/home/home.component.ts":[function(require,module,exports) {
"use strict";
...
var chat_field_component_1 = require("./chatField/chat-field.component");
...
exports.home = new Home({
  selector: 'home',
  template: home_template_1.homeTemplate,
  components: [chat_field_component_1.chatField, chat_list_component_1.chatList]
});
},{"../../framework/core/block.ts":"../src/framework/core/block.ts","./home.template":"../src/pages/home/home.template.js","./chatField/chat-field.component":"../src/pages/home/chatField/chat-field.component.ts","./chatList/chat-list.component":"../src/pages/home/chatList/chat-list.component.js"}],"../src/pages/personal_account/personal-account.template.js":[function(require,module,exports) {
"use strict";
...
},{"../../assets/img/users__avatars/avatar-3.png":"../src/assets/img/users__avatars/avatar-3.png"}],"../src/pages/personal_account/personal-account.component.ts":[function(require,module,exports) {
"use strict";
...
var personal_account_template_1 = require("./personal-account.template");
...
function (_super) {
  ...
  function PersonalAccount(properties) {
    return _super.call(this, properties) || this;
  }

  PersonalAccount.prototype.mounted = function () {
    var mail = {
      domElement: document.querySelector('#email'),
      type: 'email',
      classError: 'no-valid',
    ...
    new validation_ts_1.Validation([mail, phone, login, name, surname, nameInChat]).on();
  };

  return PersonalAccount;
}(block_ts_1.Block);

exports.personalAccount = new PersonalAccount({
  selector: 'personal-account',
  template: personal_account_template_1.personalAccountPageTemplate,
  data: {
    email: '',
    login: '',
    name: '',
...
},{"../../framework/core/block.ts":"../src/framework/core/block.ts","./personal-account.template":"../src/pages/personal_account/personal-account.template.js","../../framework/core/validation.ts":"../src/framework/core/validation.ts"}],"../src/pages/505/error-page.template.js":[function(require,module,exports) {
"use strict";
...
},{}],"../src/pages/505/error-page.component.ts":[function(require,module,exports) {
"use strict";
...
var error_page_template_1 = require("./error-page.template");
...
exports.errorPage = new ErrorPage({
  template: error_page_template_1.errorPageTemplate
});
},{"../../framework/core/block.ts":"../src/framework/core/block.ts","./error-page.template":"../src/pages/505/error-page.template.js"}],"../src/pages/404/not-found-page.template.js":[function(require,module,exports) {
"use strict";
...
},{}],"../src/pages/404/not-found-page.component.ts":[function(require,module,exports) {
"use strict";
...
var not_found_page_template_1 = require("./not-found-page.template");
...
function (_super) {
  ...
  function NotFoundPage(properties) {
    return _super.call(this, properties) || this;
  }
...
exports.notFoundPage = new NotFoundPage({
  selector: 'not-found',
  template: not_found_page_template_1.notFoundPageTemplate
});
},{"../../framework/core/block.ts":"../src/framework/core/block.ts","./not-found-page.template":"../src/pages/404/not-found-page.template.js"}],"../src/router/routes.ts":[function(require,module,exports) {
"use strict";
...
var personal_account_component_1 = require("../pages/personal_account/personal-account.component");

var error_page_component_1 = require("../pages/505/error-page.component");

var not_found_page_component_1 = require("../pages/404/not-found-page.component");
...
var routes = [{
  ...
  path: '/registration',
  component: registration_component_1.registrationPage
}, {
  path: '/personal-account',
  component: personal_account_component_1.personalAccount
}, {
  path: '/505',
  component: error_page_component_1.errorPage
}, {
  path: '/404',
...
var router_ts_1 = __importDefault(require("./framework/core/router.ts"));
